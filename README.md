...
## Summary
### Key Points Recap
1. CreeperConfettiPro is an upgraded branch of CreeperConfetti, with core value of **adapting to high-version Minecraft servers from 1.20 to 1.21+**;
